...
<table class="top">
    <tr>
        ...
        <td width="40%">
            ...
            <strong>Dated:</strong> {{ $invoice->invoice_date?->format('d-m-Y') ?? now()->format('d-m-Y') }}<br><br>

            <strong>Reference No.</strong><br>
            <strong>Seed Lic No.:</strong> {{ $invoice->seed_license ?? 'GAN/FSR220001380/2022-2023' }}<br>
            <strong>Pesti Lic No.:</strong> {{ $invoice->pesti_license ?? 'GAN/FP1220002020/2022-2023' }}
        </td>
    </tr>
</table>
...
<div class="terms">
    ...
    3. Subject to Gandhinagar jurisdiction.<br>
    4. We are trading in reliable pesticides and seeds from different companies; we are not manufacturers and not responsible for quality.
</div>
