<x-layouts.app>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">{{ __('Create Variant') }}</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('Add a new product variant') }}</p>
        </div>
                ...
                <form action="{{ route('product-variants.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
                            ...
                            <x-forms.input label="SKU" name="sku" value="{{ old('sku') }}" required />
