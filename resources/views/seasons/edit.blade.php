<x-layouts.app>
    ...
    <!-- Page Title -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ __('Edit Season') }}</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">
            {{ __('Update season details') }}
        </p>
    </div>
    ...
    <div class="p-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <form action="{{ route('seasons.update', $season) }}" method="POST" class="max-w-2xl space-y-4">
                @csrf
                @method('PUT')
                ...
                <div class="flex items-center gap-3 pt-4">
                    <x-button type="primary">{{ __('Update Season') }}</x-button>
